...
// Get blog details (only if owned by this consultant)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update blog (consultants can't change status directly)
    $stmt = $conn->prepare("UPDATE blogs SET 
        title = ?, content = ?, tags = ?, meta_description = ?, featured_image = ?
        WHERE id = ? AND author_id = ?");
    
    $stmt->bind_param("sssssii", $title, $content, $tags, $meta_description, 
        $image_path, $blog_id, $consultant_id);
    ...
    <div class="ml-0 lg:ml-[280px] min-h-screen bg-gray-50">
        <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden p-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                Current Status: <span class="font-bold capitalize"><?php echo $blog['status']; ?></span>
                                <?php if ($blog['status'] == 'rejected'): ?>
                                    - Please review and update your content before resubmitting.
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                ...
                <form action="consultant_edit_blog.php?id=<?php echo $blog_id; ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <div class="p-2 bg-gray-100 rounded-md">
                                <span class="capitalize"><?php echo $blog['status']; ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between">
                        <button type="button" onclick="if(confirm('Are you sure you want to delete this blog post?')) { window.location.href='consultant_delete_blog.php?id=<?php echo $blog_id; ?>'; }"
